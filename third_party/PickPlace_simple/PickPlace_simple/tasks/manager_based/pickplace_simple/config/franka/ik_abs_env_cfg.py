...
@configclass
class PickPlaceSimpleEnvCfg(joint_pos_env_cfg.PickPlaceSimpleEnvCfg):
...
@configclass
class FrankaCubeLiftEnvCfg_PLAY(PickPlaceSimpleEnvCfg):
    def __post_init__(self):
        # post init of parent
        super().__post_init__()
...
@configclass
class FrankaTeddyBearLiftEnvCfg(PickPlaceSimpleEnvCfg):
    def __post_init__(self):
        # post init of parent
        super().__post_init__()
