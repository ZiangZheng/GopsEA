...
"""
1 15 -16 20 6 30 30 100 1e-3 1e-3
"""
...
def object_is_lifted(
    ...
    # 物块-目标位姿计算
    is_high_enough = distance_z > 0.04
    is_close_enough_h = distance_xy < 0.04
...
def object_at_target(
    ...
    # 判断物体是否进入势能谷
    is_high_enough = object.data.root_pos_w[:, 2] > 0.04
    is_close_enough_h = distance_xy < 0.04
...
def let_object_go(
    ...
    return is_close_enough_h * is_put_down * (is_gripper_open / 0.01)
