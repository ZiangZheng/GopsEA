...
from gops_tasks.original.utils.gops_path import sampler_path, underline2camel
...
for sampler_file in sampler_file_list:
    if sampler_file[-3:] == ".py" and sampler_file[0] != "_" and sampler_file != "base.py":
        ...
        mdl = importlib.import_module("gops_tasks.original.trainer.sampler." + sampler_name)
