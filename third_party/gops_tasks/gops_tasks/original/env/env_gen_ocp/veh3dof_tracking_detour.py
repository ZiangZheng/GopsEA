...
from gops_tasks.original.env.env_gen_ocp.context.ref_traj_with_static_obstacle import RefTrajWithStaticObstacleContext
from gops_tasks.original.env.env_gen_ocp.veh3dof_tracking import Veh3DoFTracking, ego_vehicle_coordinate_transform
