...
from gops_tasks.original.create_pkg.create_sampler import create_sampler
from gops_tasks.original.utils.common_utils import get_args_from_json
from gops_tasks.original.utils.gops_path import camel2underline

from gops_tasks.original.env.py2slx_tools.export import check_jit_compatibility, export_model
...
class Py2slxRunner:
    ...
    def __load_policy(self, log_policy_dir: str, trained_policy_iteration: str):
        ...
        file = importlib.import_module("gops_tasks.original.algorithm." + alg_file_name)
