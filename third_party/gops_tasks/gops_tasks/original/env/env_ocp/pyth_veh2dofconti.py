...
from gops_tasks.original.env.env_ocp.resources.ref_traj_data import MultiRefTrajData
from gops_tasks.original.utils.math_utils import angle_normalize
...
class PythVeh2dofconti(PythBaseEnv):
    metadata = {
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super(PythVeh2dofconti, self).__init__(work_space=work_space, **kwargs)
...
def env_creator(**kwargs):
    ...
    """
    return PythVeh2dofconti(**kwargs)
