...
from gops_tasks.original.env.env_ocp.env_model.pyth_veh2dofconti_model import PythVeh2dofcontiModel
from gops_tasks.original.utils.gops_typing import InfoDict


class PythVeh2dofcontiErrCstrModel(PythVeh2dofcontiModel):
    def __init__(
        self,
        pre_horizon: int,
...
def env_model_creator(**kwargs):
    return PythVeh2dofcontiErrCstrModel(**kwargs)
