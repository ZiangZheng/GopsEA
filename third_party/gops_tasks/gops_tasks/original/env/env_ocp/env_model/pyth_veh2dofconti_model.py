...
from gops_tasks.original.env.env_ocp.pyth_veh2dofconti import angle_normalize, VehicleDynamicsData
from gops_tasks.original.env.env_ocp.resources.ref_traj_model import MultiRefTrajModel
...
class PythVeh2dofcontiModel(PythBaseModel):
    def __init__(
        self,
        pre_horizon: int = 10,
...
def env_model_creator(**kwargs):
    ...
    """
    return PythVeh2dofcontiModel(**kwargs)
