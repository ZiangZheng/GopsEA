...
from gops_tasks.original.env.env_ocp.env_model.pyth_veh3dofconti_model import (
...
class PythVeh3dofcontiSurrCstrModel(PythVeh3dofcontiModel):
    def __init__(
        self,
        pre_horizon: int,
...
def env_model_creator(**kwargs):
    return PythVeh3dofcontiSurrCstrModel(**kwargs)
