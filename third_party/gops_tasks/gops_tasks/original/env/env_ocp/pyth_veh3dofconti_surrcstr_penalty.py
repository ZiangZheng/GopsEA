...
from gops_tasks.original.env.env_ocp.pyth_veh3dofconti import PythVeh3dofconti, angle_normalize, ego_vehicle_coordinate_transform
...
class PythVeh3dofcontiSurrCstrPenalty(PythVeh3dofconti):
    def __init__(
        self,
        pre_horizon: int = 10,
...
def env_creator(**kwargs):
    return PythVeh3dofcontiSurrCstrPenalty(**kwargs)
