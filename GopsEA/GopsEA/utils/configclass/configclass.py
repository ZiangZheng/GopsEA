...
def _configclass_dict(self, name):
...
def configclass(cls, **kwargs):
    ...
    .. code-block:: python
        ...
        from GopsEA.utils.configclass import configclass
    ...
    setattr(cls, "__getitem__", _configclass_dict)
    setattr(cls, "pop", _configclass_dict)
