...
class G1FlatEnvCfg(TrackingEnvCfg):
    def __post_init__(self):
        ...
        self.actions.joint_pos.scale = 1 # G1_ACTION_SCALE
        ...
        self.commands.motion.motion_file = '/home/bravo/zhuoheng_space/whole_body_tracking/artifacts/walk1_subject1:v0/motion.npz'
