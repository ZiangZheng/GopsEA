...
from .direct_based.transition_buffer import DirectTransitionBufferCfg

if TYPE_CHECKING:
    from RenforceRL.buffer import ReplayBufferBaseCfg, ReplayBufferBase, PipeBufferBase
...
class ReplayBundle:
    ...
    def construct_replay_buffer(self, env, device) -> ReplayBufferBase:
         return self.replay_buffer_cfg.construct_from_cfg(
            dim_params = env.dim_params,
            device = device,
