...
class TDMPC2LatentDynamics(LatentDynamicsBase):
    cfg: TDMPC2LatentDynamicsCfg

    def __init__(self, cfg: TDMPC2LatentDynamicsCfg, obs_dim, action_dim, **kwargs):
...
@configclass
class TDMPC2LatentDynamicsCfg(LatentDynamicsBaseCfg):
    class_type: type[TDMPC2LatentDynamics] = TDMPC2LatentDynamics
