...
from .. import RenforceRLVecEnv
from typing import TYPE_CHECKING
if TYPE_CHECKING:
    from isaaclab.envs import DirectRLEnv, ManagerBasedRLEnv


class RenforceRLLabEnvWrapper(RenforceRLVecEnv):
    """Wraps around Isaac Lab environment
    ...
    def __init__(self, env: "ManagerBasedRLEnv", clip_actions: float | None = None):
        ...
        Note:
            The wrapper calls :meth:`reset` at the start since the runner does not call reset.
    ...
    def episode_length_buf(self, value: torch.Tensor):
        ...
        Note:
            This is needed to perform random initialization of episode lengths
        """
