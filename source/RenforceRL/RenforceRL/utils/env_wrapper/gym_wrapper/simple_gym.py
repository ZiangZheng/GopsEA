...
class SimpleGymVecEnv(RenforceRLVecEnv):
    """Minimal wrapper for gym.make("CartPole-v1") to RenforceRL VecEnv."""
...
class SimpleGymWrapper:
    ...
    def step(self, actions: torch.Tensor):
        ...
        self.post_step()
        extras = {
            "td_observations": {"policy": obs_tensor},
            "observations": {"policy": self._last_obs},
        ...
        return self._last_obs, reward, done, extras
