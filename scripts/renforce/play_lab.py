...
from RenforceRL.utils import argtool  # isort: skip
...
from RenforceRL.runners import BaseRunner, BaseRunnerCfg
...
def main():
    ...
    if task_name is None:
        ...
        agent_cfg = load_cfg_from_registry(task_name, "RenforceRL_entry_point")
